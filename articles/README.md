...
- `news/hmis-release-notes.md` and `news/warehouse-release-notes.md` — product-specific release notes kept outside the procedural knowledge-base import. Map or publish these separately if release notes should appear in WordPress.
